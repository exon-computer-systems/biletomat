const data = [
  ...
  {
    artist: "Beyoncé",
    description: "Dołącz do Beyoncé na niezapomnianą noc muzyki i tańca.",
    date: "2024-10-05",
    totalSeats: 30000,
    availableSeats: 5000,
    coverImage:
  ...
  {
    artist: "Rihanna",
    description: "Rihanna powraca na scenę z niezwykłym występem na żywo.",
    date: "2024-10-15",
    totalSeats: 30000,
    availableSeats: 5000,
    coverImage:
  ...
  {
    artist: "Post Malone",
    description: "Nie przegap koncertu Post Malone z jego największymi hitami.",
    date: "2024-12-20 - 2024-12-21",
    totalSeats: 30000,
    availableSeats: 7000,
    coverImage: "https://muzyk.net/wp-content/uploads/2023/04/postmalone.jpg",
    images: [
